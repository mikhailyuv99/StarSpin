...
const PRIZE_COLUMNS =
  "id, merchant_id, label, icon, probability_weight, rarity_tier, prize_mechanic, social_unlock_platform, stock_remaining, active, redeem_next_visit, redeem_min_spend_cents, redeem_valid_days, created_at";
