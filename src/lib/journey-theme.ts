...
export const JOURNEY_TEMPLATES: Record<JourneyTemplateId, JourneyTemplateDef> = {
  ...
  pop: {
    ...
    vars: {
      ...
      "--pj-card-radius": "22px",
      "--pj-card-shadow": "7px 7px 0 0 #0a0a0a",
      "--pj-btn-radius": "14px",
      "--pj-btn-border": "3px solid #0a0a0a",
      "--pj-btn-shadow": "4px 4px 0 0 #0a0a0a",
      "--pj-btn-hover-shadow": "6px 6px 0 0 #0a0a0a",
      ...
      "--pj-pill-shadow": "2px 2px 0 0 #0a0a0a",
      "--pj-logo-radius": "16px",
  ...
  arcade: {
    ...
    vars: {
      ...
      "--pj-card-radius": "18px",
      "--pj-card-shadow":
        "0 0 0 1px rgba(255,255,255,0.05), 0 18px 45px rgba(124,92,255,0.35), 0 0 30px rgba(0,229,255,0.18)",
      "--pj-btn-radius": "12px",
      "--pj-btn-border": "1.5px solid rgba(255,255,255,0.25)",
      "--pj-btn-shadow": "0 8px 22px rgba(255,62,165,0.4)",
      "--pj-btn-hover-shadow": "0 10px 30px rgba(255,62,165,0.6)",
      ...
      "--pj-pill-shadow": "0 0 14px rgba(255,62,165,0.6)",
      "--pj-logo-radius": "14px",
  ...
  aurora: {
    ...
    vars: {
      ...
      "--pj-card-radius": "24px",
      "--pj-card-shadow":
        "0 2px 0 0 rgba(255,255,255,0.6) inset, 0 22px 48px rgba(124,92,255,0.22)",
      "--pj-card-backdrop": "blur(14px)",
      "--pj-btn-radius": "999px",
      "--pj-btn-border": "1px solid rgba(255,255,255,0.7)",
      "--pj-btn-shadow": "0 10px 26px rgba(124,92,255,0.35)",
      "--pj-btn-hover-shadow": "0 14px 34px rgba(124,92,255,0.5)",
      ...
      "--pj-pill-active-ink": "#ffffff",
      "--pj-pill-shadow": "0 6px 16px rgba(124,92,255,0.4)",
      "--pj-logo-radius": "20px",
  ...
  luxe: {
    ...
    vars: {
      ...
      "--pj-card-radius": "14px",
      "--pj-card-shadow": "0 24px 55px rgba(43,33,24,0.16)",
      "--pj-btn-radius": "8px",
      "--pj-btn-border": "1px solid rgba(184,145,47,0.5)",
      "--pj-btn-shadow": "0 10px 24px rgba(43,33,24,0.14)",
      "--pj-btn-hover-shadow": "0 14px 30px rgba(43,33,24,0.2)",
      ...
      "--pj-pill-shadow": "0 4px 12px rgba(184,145,47,0.35)",
      "--pj-logo-radius": "50%",
  ...
  noir: {
    ...
    vars: {
      ...
      "--pj-card-radius": "14px",
      "--pj-card-shadow": "0 24px 55px rgba(0,0,0,0.55), 0 0 22px rgba(212,175,95,0.12)",
      "--pj-card-backdrop": "blur(10px)",
      "--pj-btn-radius": "8px",
      "--pj-btn-border": "1px solid rgba(212,175,95,0.55)",
      "--pj-btn-shadow": "0 12px 30px rgba(0,0,0,0.5)",
      "--pj-btn-hover-shadow": "0 16px 38px rgba(212,175,95,0.3)",
      ...
      "--pj-pill-shadow": "0 0 14px rgba(212,175,95,0.4)",
      "--pj-logo-radius": "50%",
  ...
  candy: {
    ...
    vars: {
      ...
      "--pj-card-radius": "28px",
      "--pj-card-shadow": "0 12px 0 0 rgba(255,143,199,0.35), 0 20px 40px rgba(255,95,162,0.2)",
      "--pj-btn-radius": "999px",
      "--pj-btn-border": "3px solid #6b2d5c",
      "--pj-btn-shadow": "0 6px 0 0 #6b2d5c",
      "--pj-btn-hover-shadow": "0 8px 0 0 #6b2d5c",
      "--pj-outline-bg": "#ffffff",
      ...
      "--pj-pill-active-ink": "#ffffff",
      "--pj-pill-shadow": "0 4px 0 0 #6b2d5c",
      "--pj-logo-radius": "24px",
  ...
  minimal: {
    ...
    vars: {
      ...
      "--pj-card-radius": "20px",
      "--pj-card-shadow": "0 1px 2px rgba(0,0,0,0.04), 0 18px 44px rgba(15,15,16,0.07)",
      "--pj-btn-radius": "12px",
      "--pj-btn-border": "1px solid transparent",
      "--pj-btn-shadow": "0 1px 2px rgba(0,0,0,0.08)",
      "--pj-btn-hover-shadow": "0 10px 24px rgba(79,70,229,0.28)",
      "--pj-outline-bg": "#ffffff",
      ...
      "--pj-pill-active-ink": "#ffffff",
      "--pj-pill-shadow": "0 6px 16px rgba(79,70,229,0.3)",
      "--pj-logo-radius": "14px",
