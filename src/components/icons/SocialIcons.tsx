...
const BRAND_ICONS: Record<Exclude<SocialBrand, "google">, SimpleIcon> = {
...
/** Official four-color Google "G" (brand asset paths). */
...
export function SocialIcon({ brand, size = 18, className = "", title }: SocialIconProps) {
  const label =
    title ?? (brand === "google" ? siGoogle.title : BRAND_ICONS[brand].title);
