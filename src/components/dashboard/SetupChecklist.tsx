...
export function SetupChecklist({
 ...
 className="flex items-center gap-3 rounded-[14px] border-2 border-black bg-white px-4 py-3 transition-transform hover:-translate-x-0.5 hover:-translate-y-0.5 "
 >
 <span
 ...
 <span className="shrink-0 text-base font-black text-ink" aria-hidden>
 →
 </span>
 </Link>
 </li>
