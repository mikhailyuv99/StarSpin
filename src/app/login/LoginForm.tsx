...
function OAuthIcon({ provider }: { provider: "google" | "apple" }) {
  ...
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" aria-hidden>
      <path
        fill="currentColor"
        d="M16.365 1.43c0 1.14-.93 2.07-2.07 2.07-.03 0-.06 0-.09-.01-.02-1.1.9-2.01 2.01-2.06Zm2.4 5.94c-1.36-.08-2.47.44-3.12 1.4-.72 1.06-.76 2.8-.2 4.03 1.01 2.2 3.52 2.05 3.52 2.05V20.5h2.9V7.37h-2.9v.62c0 0-1.3-.95-3.2-.62Z"
      />
    </svg>
  );
}
