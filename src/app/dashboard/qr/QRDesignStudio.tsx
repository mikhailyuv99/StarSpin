...
export function QRDesignStudio({ merchant }: { merchant: Merchant }) {
 ...
 className={`rounded-[10px] border-2 border-black px-3 py-1.5 text-xs font-extrabold uppercase ${
 ...
 className={`rounded-[14px] border-2 border-black px-4 py-2 text-sm font-extrabold ${
