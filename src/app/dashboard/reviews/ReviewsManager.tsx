            ...
            <div className="border-t-2 border-black/10 bg-[#fafafa] p-4">
              ...
              >
                ...
                <img
                  ...
                  className="mx-auto max-h-80 w-full max-w-md rounded-lg border-2 border-black object-contain shadow-[3px_3px_0_0_#0a0a0a] transition group-hover:-translate-y-0.5"
                />
              </a>
